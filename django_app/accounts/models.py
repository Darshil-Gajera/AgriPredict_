...
# ✅ Custom User Manager (FIXES YOUR ERROR)
...
# ✅ Saved Results Model (unchanged, just cleaned)
class SavedResult(models.Model):
    ...
    subject_group = models.CharField(max_length=10, blank=True)  # PCM / PCB
    city = models.CharField(max_length=100, blank=True)
    district = models.CharField(max_length=100, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    label = models.CharField(max_length=120, blank=True, help_text="Optional note")
